...
@end
@interface CameraTag : NSObject

@property (nonatomic, copy) NSString *rowcount;

@property (nonatomic, strong) NSArray<CameraSource *> *source;
...
@property (nonatomic, strong) NSArray<CameraSocial_Discuz *> *social_discuz;

@end

@interface CameraCamera : NSObject
...
@interface CameraAddress_Json : NSObject
...
@interface CameraPhotoalbum : NSObject
...
@interface CameraSocial_Discuz : NSObject
